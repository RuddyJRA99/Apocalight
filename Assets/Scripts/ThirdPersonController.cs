...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (_input.crouch || !_shadowRayController.IsPowerShadow())
            {
                CrouchMove(true);
            }
            else
        ...
        void CrouchMove(bool state)
        {
            if (state)
            {
                _animator.SetLayerWeight(AnimatorLayer.CROUCH, Mathf.Lerp(_animator.GetLayerWeight(AnimatorLayer.CROUCH), 0.9f, Time.deltaTime * 10f));
                _controller.height = CrouchHeight;
                _controller.center = CrouchCenter;
            }
            else
            {
                _animator.SetLayerWeight(AnimatorLayer.CROUCH, Mathf.Lerp(_animator.GetLayerWeight(AnimatorLayer.CROUCH), 0f, Time.deltaTime * 10f));
